...
public partial class ScaleGizmo : BuildmodeGizmo
{
	...
	public override void _Input(InputEvent @event)
	{
		if (Input.IsActionJustPressed("build_gizmo_drag"))
		{
			...
			_initialScale = BuildmodeService.I.CurrentSelected.Scale;
			_targScale = BuildmodeService.I.CurrentSelected.Scale; 
	...
	{
		var s = BuildmodeService.I.CurrentSelected.Scale;
		var a = amount * _sensitivity;

		if (dir == Direction.X)
		{
			_targScale.X = _initialScale.X + a;
		}
		else if (dir == Direction.Y)
		{
			_targScale.Y = _initialScale.Y + a;
		}
		else if (dir == Direction.Z)
		{
			_targScale.Z = _initialScale.Z + a;
		}
		s = _targScale;
		BuildmodeService.I.CurrentSelected.Scale = s;
